...
extension WidgetData {
    ...
    static func write(location: String?, currentWeather: CurrentWeather?, forecast: [Forecast]?) {
        ...
        let data = WidgetData(location: location, temperature: currentWeather.temperature, icon: currentWeather.icon, weather: currentWeather.weather, minTemperature: currentWeather.minTemperature, maxTemperature: currentWeather.maxTemperature, date: currentWeather.forecastedDate)
